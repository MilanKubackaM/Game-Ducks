...
public class Bill extends ActionCard {
    public Bill(){    }

    public void Fire(int id, ArrayList<BoardElement> cardsOnBoard, ListIterator<PondCard> pondCardsShuffledIterator, Player[] player){
